...
struct AccessibilityAuditView: View {
    ...
    let items: [AuditItem] = [
        ...
        AuditItem(category: "VoiceOver", item: "AvatarView has descriptive accessibilityLabel", status: .pass),
        AuditItem(category: "VoiceOver", item: "Emoji reaction pills describe action and count", status: .pass),
        AuditItem(category: "VoiceOver", item: "Media attachment thumbnails labelled with alt text", status: .pass),
        AuditItem(category: "VoiceOver", item: "Lightbox close button labelled", status: .pass),
        AuditItem(category: "VoiceOver", item: "Trending hashtag rows labelled for VoiceOver", status: .pass),
